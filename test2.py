...
if deurkeuze_kamer_7 == "a":
    ...
    if antwoord == som:
        ...
        print("Grrrrr")
        time.sleep(1)
        print("Je hoort een griezelig geluid, het komt bij de deur achter het standbeeld vandaan.")
    time.sleep(1)
        ...
        if zombie_hit_damage <= 0:
            ...
            while zombie_health > 0 or player_health > 0:
                ...
                if zombie_health > 0:
                    ...
                    print("De zombie heeft een sleutel laten vallen. Deze neem je mee. ")
                    #got_dolk = True
                    got_key = True
                    ...
                    break
        if antwoord != som:
            deurkeuze_kamer_6 = input("Je ziet 3 deuren. (Enter) Wil je rechtdoor gaan of (a) wil je naar rechts of (b) wil je naar links? ") # kan ook gedaan worden met een som ivm if statement dat nog steeds true gezet kan worden.
        else:
...
# In deze kamer staat een balista (een soort katapult met een grote pijl er op). 
# Vanuit deze kamer kan de speler er voor kiezen om in 1 keer de boss verslaan in de kamer er naast. 
# Je gaat vanuit deze kamer naar kamer 10.

if deurkeuze_kamer_6 == "b":
    print("Je komt een hele lange trap tegen.")
    time.sleep(1)
    print("Aan het einde van de trap, loop je een kamer binnen.")
    time.sleep(1)
    print("In de kamer staat een balista.")
    use_balista = input("Wil je de balista gebruiken om de boss te doden? (ja) of (nee)? ")


# === [kamer 10] === #

# Het gevecht hier vind niet plaats als de speler er voor heeft 
# gekozen om de balista in kamer 15 te gebruiken.

boss_attack = 3
boss_defense = 1
boss_health = 5
# or deurkeuze_kamer_6 == "b"
if got_boss_key or deurkeuze_kamer_3 != "a":
    ...
    time.sleep(1)
    if use_balista == "ja":
        print("Maar de boss is al gedood door de balista.")
        time.sleep(1)
        print("Je loopt door de volgende deur.")
